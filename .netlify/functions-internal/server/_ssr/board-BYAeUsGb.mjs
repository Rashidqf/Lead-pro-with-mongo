...
import { D as Building2, f as Search, g as Mail, m as Phone, p as Plus, u as SlidersHorizontal } from "../_libs/lucide-react.mjs";
import { c as Select, d as SelectTrigger, f as SelectValue, l as SelectContent, u as SelectItem } from "./dialog-Ci354SI_.mjs";
import { a as initials, i as displayName, n as columnsQuery, o as logActivity, r as contactsQuery, s as profilesQuery } from "./crm-CAfoegO2.mjs";
import { n as ContactDialog } from "./ContactDialog-qVTRpTp3.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/board-BYAeUsGb.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var PAGE = 25;
function KanbanBoard({ columns, contacts, profiles, onOpenContact }) {
	const queryClient = useQueryClient();
	const { userId } = useCrmAuth();
	...
	const move = useMutation({
		mutationFn: async ({ contact, columnId }) => {
			const { error } = await supabase.from("contacts").update({ column_id: columnId }).eq("id", contact.id);
			if (error) throw error;
			if (userId) {
				const target = columns.find((c) => c.id === columnId);
				await logActivity(userId, contact.id, "moved", `${contact.name} → ${target?.name ?? ""}`);
			}
		},
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					contact.phone && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
						className: "flex items-center gap-1.5 truncate",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Phone, { className: "h-3 w-3" }), contact.phone]
					}),
