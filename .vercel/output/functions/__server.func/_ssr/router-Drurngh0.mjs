...
import { n as getMe, t as AuthProvider } from "./use-crm-auth-CgWrhDrj.mjs";
...
import { a as jsonResponse, i as corsPreflight, n as claimNextCall, r as companionLogin, s as updateCallJob, t as authCompanion } from "./companion.server-BVD9W4MC.mjs";
import { t as ThemeProvider } from "./theme-heZV5ekf.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/router-Drurngh0.js
...
var $$splitComponentImporter$12 = () => import("./route-CXCrxiGr.mjs");
...
var $$splitComponentImporter$11 = () => import("./auth-Ck7m4dl1.mjs");
...
var $$splitComponentImporter$10 = () => import("./board-BBLcvj-s.mjs");
...
var $$splitComponentImporter$9 = () => import("./contacts-N1EM_5Rs.mjs");
...
var $$splitComponentImporter$8 = () => import("./dashboard-Bz3mKhK-.mjs");
...
var Route$1 = createFileRoute("/api/companion/login")({ server: { handlers: {
	...
	POST: async ({ request }) => {
		try {
			...
			return jsonResponse(await companionLogin(body.email, body.password, body.deviceName ?? "Android"));
		} catch (err) {
...
var Route = createFileRoute("/api/companion/next-call")({ server: { handlers: {
	...
	GET: async ({ request }) => {
		try {
			...
			return jsonResponse({ job: await claimNextCall(user.userId, deviceId) });
		} catch (err) {
