...
import { t as getServerFnById } from "../__23tanstack-start-server-fn-resolver--_EBRLKu.mjs";
...
import { i as requestHandler, r as getResponse } from "./request-response-DOhekycA.mjs";
import { t as createCsrfMiddleware } from "./createCsrfMiddleware-DPUJvxsO.mjs";
require_react();
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-1tjwQhOU.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-Drurngh0.mjs"),
		import("./start-04nI7_NF.mjs"),
		import("./empty-plugin-adapters-BAnILYjY.mjs")
	]);
	return {
		routerEntry,
		startEntry,
