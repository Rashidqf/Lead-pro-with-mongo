...
import { t as DATE_RANGE_LABELS } from "./finance-BECJPU_k.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/FinanceShared-BUgNjM61.js
...
function FinanceNavLink({ to, exact, children }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
		to,
		className: cn("rounded-md px-3 py-1.5 text-sm font-medium transition-colors", (exact ? pathname === to : pathname.startsWith(to)) ? "bg-accent text-accent-foreground" : "text-muted-foreground hover:bg-accent/60 hover:text-foreground"),
		children
	});
}
